...
public class PayloadVerifier implements AutoCloseable {
   ...
   */
    private static void CheckAllFilesInPayloadDirAreListedInAllManifests(final Set<Manifest> payLoadManifests, final Path payloadDir, final boolean ignoreHiddenFiles) throws IOException {
